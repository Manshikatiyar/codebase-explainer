    ...
    register.mutate(
      { data: values },
      {
        onSuccess: (data) => {
          ...
          toast({ title: "Account created", description: "Welcome to ExplainMyCode." });
        },
        onError: (error) => {
          toast({
            variant: "destructive",
      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;Stop reading thousands of lines of code. Get to the core architecture and logic instantly.&rdquo;
            </p>
          </blockquote>
        </div>
      </div>
